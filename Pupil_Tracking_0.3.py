...
DISPLACEMENT_MULTIPLIER_X = 2  # Multiplier for horizontal movement
DISPLACEMENT_MULTIPLIER_Y = 4  # Multiplier for vertical movement (adjust this value as needed)
HEAD_MOVEMENT_THRESHOLD = 20   # Threshold for head movement 
...
while cap.isOpened() and (time.time() - start_time < record_duration):
    ...
    # Display the flipped frame (optional, if you want to see the flipped frame during recording)
